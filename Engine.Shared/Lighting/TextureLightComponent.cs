...
/// </summary>
[RegisterComponent("TextureLight"), NetworkedComponent]
public sealed partial class TextureLightComponent : Component
{
    /// <summary>
    /// Asset key for the light texture
    /// (e.g. <c>"Lights/SpotlightCone"</c>).
    /// </summary>
    [NetField] public string Texture { get; set; } = string.Empty;
    ...
    /// </summary>
    [NetField] public Vector2 Scale { get; set; } = Vector2.One;
    ...
    /// </summary>
    [NetField] public float Rotation { get; set; } = 0f;

    /// <summary>
    /// When true, the light is occluded by world geometry and casts shadows.
    /// </summary>
    [NetField] public bool CastShadows { get; set; } = false;
}
