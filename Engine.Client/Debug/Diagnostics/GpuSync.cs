...
/// <summary>
/// Forces the GPU to finish everything submitted so far. MonoGame/DesktopGL
/// doesn't expose a real GPU timer query, so this is how <see cref="Engine.Shared.Debug.Diagnostics.FrameProfiler.GpuScope"/>
/// measures the work the driver actually did instead of just how long it
/// took to queue the commands.
/// </summary>
